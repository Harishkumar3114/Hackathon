...
const Analytics = () => {
    ...
    return (
      ...
      >
        <Typography color="error" mb={2}>
          Failed to load hub intelligence.
        </Typography>
  ...
  const analyticsSource = data.detailedAnalytics || data.links || [];

  const topLink =
    analyticsSource.length > 0
      ? [...analyticsSource].sort(
          (a, b) => (b.totalClicks || b.clicks) - (a.totalClicks || a.clicks),
        )[0]
      : null;
  return (
      ...
      >
        <Container maxWidth="lg">
          ...
          <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 6 }}>
            <IconButton
              onClick={() => navigate(-1)}
              sx={{ color: "primary.main", border: "1px solid #1a1a1a" }}
            >
              <ArrowBack />
            </IconButton>
          ...
          <Grid container spacing={3} sx={{ mb: 6 }}>
            <Grid item xs={12} sm={6} md={4}>
              <Paper
                variant="outlined"
                sx={{ p: 4, borderRadius: 4, border: "1px solid #1a1a1a" }}
              >
          ...
          >
            <Table sx={{ minWidth: { xs: 500, md: "100%" } }}>
              ...
              <TableBody>
                {(data.detailedAnalytics || data.links || []).map(
                  (link, idx) => (
                    <TableRow key={idx}>
                      ...
                      <TableCell align="center">{link.ctr || "0%"}</TableCell>
